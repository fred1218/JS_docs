        ...
        var methods = {
            ...
            init: function (option) {
                return this.each(function () {
                    ...
                    //data是数据则直接渲染，是字符串则可能是url，没做正则判断
                    ...
                    function createSeats(seatData) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            switch (seatType) {
                                ...
                                case 'LO':
                                    totalCanSelCount++;
                                    chtml += '<' + opt.seatEl + ' title="' + titleInfo + '" class="' + opt.seat + ' ' + opt.canSelected + ' ' + opt.lover + '" hidefocus="true" data-no="' + seatNo + '" href="javascript:;" data-row=' + rowId + ' data-column=' + columnId + ' data-type="LO" data-pair=' + v.pair + '></' + opt.seatEl + '>';
                                    break;
                                default:
                                    break;
                        ...
                        $cont.on("click.initCinema", opt.seatEl + "." + opt.seat, function (ev) {
                            ...
                            switch (stype) {
                                case 'N':
                                    ...
                                    break;
                                case 'LO':
                                    var pairCOde = $(this).data("pair");
                                    //如何断定是情侣座，相邻，相同的paircode
                                    //var halfLoverEl = $(this).next("[data-type='LO'][data-pair='" + pairCOde + "']").length > 0 ? $(this).next("[data-type='LO'][data-pair='" + pairCOde + "']") : $(this).prev("[data-type='LO'][data-pair='" + pairCOde + "']");
                                    //从siblings元素当中寻找
                                    var halfLoverEl = $(this).siblings("[data-type='LO'][data-pair='" + pairCOde + "']");
